...
<div class="myMain">
  <?php include('processOID.php'); ?>
  <form id="contact" action="<?= htmlspecialchars($_SERVER["PHP_SELF"]) ?>" method="post">
    <h2>Ordered Item Details</h2>
	<p>* required fields</p>
	
    <fieldset>
    Enter Unique Order ID Number: <input placeholder="#" type="text" name="OrderID" value="<?= $OrderID ?>" tabindex="1" autofocus>
      <span class="error">* <?= $OrderID_error ?></span>
	</fieldset>  
      <span class="error"> Details of the Item associated with this Order ID will be displayed.<br></span>
