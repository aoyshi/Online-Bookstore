...
<div class="myMain">
  <?php include('processUpdatePrices.php'); ?>
  <form id="contact" action="<?= htmlspecialchars($_SERVER["PHP_SELF"]) ?>" method="post">
    ...
    <fieldset>
    <b>Choose Type:</b>
      <input type="radio" name="type" value="book" /> Books <input type="radio" name="type" value="film" /> Films <input type="radio" name="type" value="periodical" checked="checked"/> Periodicals
	  <span class="error">*</span>
	</fieldset> 
    <fieldset>
    <b>Enter Price Update:</b>
	  <input type="radio" name="update" value="increase" checked="checked"/> Increase By
	  <input type="radio" name="update" value="decrease" /> Decrease By
	
	<input placeholder="  e.g  2.50" type="text" name="amount" value="<?= $amount ?>"> %
