...
<div class="myMain">
  <?php include('processNewAuthor.php'); ?>
  <form id="contact" action="<?= htmlspecialchars($_SERVER["PHP_SELF"]) ?>" method="post">
    ...
    <fieldset>
    Nationality: <input placeholder="e.g Brazilian" type="text" name="nationality" value="<?= $nationality ?>" tabindex="3">
      <span class="error">* <?= $nationality_error ?></span>
    </fieldset>
	<fieldset>
