...
<div class="myMain">
    <?php include('processNewOrder.php'); ?>
  <form id="contact" action="<?= htmlspecialchars($_SERVER["PHP_SELF"]) ?>" method="post">
    <h2>Place New Order</h2>
	<p>* required fields</p>
	
    <fieldset>
    Enter Username of Customer placing order: <input type="text" name="CusID" value="<?= $CusID ?>" tabindex="1" autofocus>
      <span class="error">* <?= $CusID_error ?></span>
    </fieldset>
    <fieldset>
    Enter ID Number of Item to be ordered: <input placeholder="#" type="text" name="ItemID" value="<?= $ItemID ?>" tabindex="2">
      <span class="error">* <?= $ItemID_error ?></span>
	  <span class="cost"> <?= $show_cost ?></span>
    </fieldset>
	<fieldset>
    How many copies of this Item do you want to order? <input placeholder="#" type="text" name="quantity" value="<?= $quantity ?>" tabindex="3">
