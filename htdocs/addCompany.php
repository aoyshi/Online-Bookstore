...
<div class="myMain">
  <?php include('processNewCompany.php'); ?>
  <form id="contact" action="<?= htmlspecialchars($_SERVER["PHP_SELF"]) ?>" method="post">
    ...
    <fieldset>
    Headquarter Location: <input type="text" name="location" value="<?= $location ?>" tabindex="3">
      <span class="error">* <?= $location_error ?></span>
    </fieldset>
	<fieldset>
    CEO: <input placeholder="First Last" type="text" name="ceo" value="<?= $ceo ?>" tabindex="4" >
      <span class="error">* <?= $ceo_error ?></span>
    </fieldset>
