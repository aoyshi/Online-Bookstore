...
<div class="myMain">
  <?php
	...
	$query = "select *
	          from item,genre,book,audio_book
			  where Genre_ID=ID and ItemID=BookID and BookID=AudioID and Availability='1';";
	$response = @mysqli_query($conn,$query);
	if($response) 
	{
		echo '<h3>AVAILABLE AUDIO-BOOKS</h3>';
	...
	$query = "select *
	          from item,genre,book,audio_book
			  where Genre_ID=ID and ItemID=BookID and BookID=AudioID and Availability='0';";
	$response = @mysqli_query($conn,$query);
	if($response) 
	{
		echo '<h3>UNAVAILABLE AUDIO-BOOKS</h3>';
		echo '<table cellspacing="5" cellpadding="5">
				 <tr><td><b>ItemID</b></td>
				     <td><b>Title</b></td>
					 <td><b>Genre</b></td>
