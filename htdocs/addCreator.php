...
<div class="myMain">
  <h2>Add New Creator Profile</h2>
  <a href="addAuthor.php"><button type="button">Add Author</button></a>
  
  <a href="addPublisher.php"><button type="button">Add Publisher</button></a>
  
  <a href="addCompany.php"><button type="button">Add Company</button></a>
</div> 
