...
<div class="myMain">
  <?php include('processDelete.php'); ?>
  <form id="contact" action="<?= htmlspecialchars($_SERVER["PHP_SELF"]) ?>" method="post">
    <h2>Delete A Customer</h2>
	<p>* required fields</p>
	
    <fieldset>
    Enter ID Number of Customer to delete: <input placeholder="username" type="text" name="CusID" value="<?= $CusID ?>" tabindex="1" autofocus>
      <span class="error">* <?= $CusID_error ?></span>
	</fieldset>  
      <span class="error"> ! This will also permanently delete all order records associated with the selected customer.<br></span>
