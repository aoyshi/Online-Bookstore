...
<div class="myMain">
  <?php include('processNewGenre.php'); ?>
  <form id="contact" action="<?= htmlspecialchars($_SERVER["PHP_SELF"]) ?>" method="post">
    <h2>Add New Genre</h2>
	<p>* required fields</p>
	
    <fieldset>
    Genre Name: <input type="text" name="name" value="<?= $name ?>" tabindex="1" autofocus>
      <span class="error">* <?= $name_error ?></span>
    </fieldset>
    <fieldset>
    Genre ID: <input placeholder="#" type="text" name="id" value="<?= $id ?>" tabindex="2">
