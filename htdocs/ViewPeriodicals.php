...
<div class="myMain">
  <?php
	...
	$query = "select *
	          from item,genre,periodical
			  where Genre_ID=ID and ItemID=Peri_ID and Availability='1';";
	$response = @mysqli_query($conn,$query);
	if($response) 
	{
		echo '<h3>AVAILABLE PERIODICALS</h3>';
		echo '<table cellspacing="5" cellpadding="5">
				 <tr><td><b>ItemID</b></td>
					 ...
					 <td><b>Price</b></td>
					 <td><b>Language</b></td>
					 <td><b>Volume_Number</b></td>
					 <td><b>Issue_Number</b></td>					 
			     </tr>';
	...
	$query = "select *
	          from item,genre,periodical
			  where Genre_ID=ID and ItemID=Peri_ID and Availability='0';";
	$response = @mysqli_query($conn,$query);
	
	if($response) 
	{
		echo '<h3>UNAVAILABLE PERIODICALS</h3>';
		echo '<table cellspacing="5" cellpadding="5">
				 <tr><td><b>ItemID</b></td>
				     <td><b>Title</b></td>
					 <td><b>Genre</b></td>
