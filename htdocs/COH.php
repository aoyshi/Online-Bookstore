...
<div class="myMain">
  <?php include('processCOH.php'); ?>
  <form id="contact" action="<?= htmlspecialchars($_SERVER["PHP_SELF"]) ?>" method="post">
    <h2>Customer Order History</h2>
	<p>* required fields</p>
	
    <fieldset>
    Enter Customer ID (Username): <input placeholder="username" type="text" name="CusID" value="<?= $CusID ?>" tabindex="1" autofocus>
      <span class="error">* <?= $CusID_error ?></span>
	</fieldset>  
      <span class="error"> All order records associated with the selected customer will be shown below.<br></span>
