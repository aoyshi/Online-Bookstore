...
<div class="myMain">
  <?php
	...
	$query = "select *
	          from item,genre,film
			  where Genre_ID=ID and ItemID=FilmID and Availability='1';";
	$response = @mysqli_query($conn,$query);
	if($response) 
	{
		echo '<h3>ALL AVAILABLE FILMS</h3>';
	...
	$query = "select *
	          from item,genre,film 
			  where Genre_ID=ID and ItemID=FilmID and Availability='0';";
	$response = @mysqli_query($conn,$query);
	if($response) 
	{
		echo '<h3>UNAVAILABLE FILMS</h3>';
		echo '<table cellspacing="5" cellpadding="5">
				 <tr><td><b>ItemID</b></td>
				     <td><b>Title</b></td>
					 <td><b>Genre</b></td>
